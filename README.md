...
The following instructions help you integrate with an existing CocoaPods project.
    ...
    1. Create a folder named BATester in /path/to/your/project/Vendor/
    2. Extract the contents of the SDK in to the folder named BATester
    3. Add the following line to your PodFile : 
           pod 'BATester', :path => 'Vendor/BATester'
...
the following.
    ...
    3. A new file named "BATester.xcworkspace" will be created as a result.
    4. Open the "BATester.xcworkspace" in XCode 5.0.
